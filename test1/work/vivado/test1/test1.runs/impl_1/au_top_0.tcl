...
namespace eval ::optrace {
  variable script "E:/comp struc/project/test1/work/vivado/test1/test1.runs/impl_1/au_top_0.tcl"
...
OPTRACE "set parameters" START { }
  ...
  set_property ip_output_repo {{E:/comp struc/project/test1/work/vivado/test1/test1.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{E:/comp struc/project/test1/work/vivado/test1/test1.runs/synth_1/au_top_0.dcp}}
